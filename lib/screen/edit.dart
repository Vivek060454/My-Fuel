...
class Editdatalist extends StatefulWidget {


  final produt;
   Editdatalist(this.produt,{super.key});

  @override
  EditdatalistState createState() {
    return EditdatalistState();
  }
}

class EditdatalistState extends State<Editdatalist> {
  ...
  Future<void> addUser() async {
      ...
      usersell
        ...
        'datee': DateTime.now().toString().substring(0, 10)
          ...
          .then((valure) => print('Product Update'))
  ...
  void initState() {
    ...
    _currentvalueController.text=widget.produt['CurrentValue']??'';
    _currentkeyController.text=widget.produt['CurrentKey']??'';
    _targetvalueController.text=widget.produt['TargetValue']??'';
    _targetkeyController.text=widget.produt['TargetKey']??'';
    _listnameController.text=widget.produt['ListName']??'';
